	...
	<section class="container mt-5" style="max-width: 400px;">
		<div class="card shadow-lg">
			<div class="card-header bg-primary text-white text-center">
				<h4 class="mb-0">Login</h4> <!-- Login form header -->
			</div>
			<div class="card-body">
				<!-- Login form -->
				<form method="post" action="userLoginAction.jsp"> <!-- Submit form to userLoginAction.jsp -->
					<div class="mb-3">
			...
			<div class="card-footer text-center text-muted">
				...
				<a href="userJoin.jsp" class="text-primary">Click here</a> <!-- Link to the sign-up page -->
			</div>
		</div>
	</section>
